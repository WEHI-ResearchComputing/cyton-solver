...
import type { FitResult } from '../models/FitResult';
...
export class DefaultService {
     ...
     * @throws ApiError
     */
    public indexRedirectGet(): CancelablePromise<any> {
     ...
     * @returns FitResult Successful Response
     * @throws ApiError
     */
