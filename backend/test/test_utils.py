...
from core.model_fitting import calc_n0
...
def test_n0():
    ...
    # Take the first index here because the test data only has one condition
    cell_gens_reps = experiment_data["cell_gens_reps"][0]
    n0 = calc_n0(cell_gens_reps)
